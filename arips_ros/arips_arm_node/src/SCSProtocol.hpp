...
private:
	...
	void Host2SCS(u8 *DataL, u8* DataH, int Data);//Convierte Data en Byte alto y Byte bajo segun dispositivo
	int	SCS2Host(u8 DataL, u8 DataH);//Devuelve Data extraido de Byte alto y Byte bajo segun dispositivo
	int	Ack(u8 ID);//����Ӧ��
	...
	#define P_PRESENT_POSITION_L 56 //0X38 direccion estado posicion
