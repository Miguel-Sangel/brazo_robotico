...
#        parameters=[{"use_sim_time": simulado}],
    ...
    ### Simulado= false, movemos con los deslizadores los motores
    ...
    ### Simulado= false, envia lecturas "/xxxx/joint_states" al controlador para mover motores
    comando = Node(
    ...
    ### Simulado= true, movemos con los deslizadores la simulacion
    joint_state_publisher_node_sim = Node(
        package="joint_state_publisher_gui",
        executable="joint_state_publisher_gui",
        condition=IfCondition(simulado),
    )
...
######################################################## MOVEIT ##############################################################  
    ...
    robot_description_semantic_load = load_file(
        "arips_arm_description", "moveit/brazo.srdf"
    )
    ...
    kinematics_yaml = load_yaml(
        "arips_arm_description", "moveit/kinematics.yaml"
    )
    
    joint_limits_yaml = load_yaml(
        "arips_arm_description", "moveit/joint_limits.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "arips_arm_description", "moveit/ompl_planning.yaml"
    )
#    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)
    
    moveit_simple_controllers_yaml = load_yaml(
        "arips_arm_description", "moveit/moveit_controllers.yaml"
    )
    moveit_controllers = {
...
#        static_tf, ## si especificamos origen en la etiqueta "world" del URDF, no es necesario
        ...
        joint_state_publisher_node_sim,
